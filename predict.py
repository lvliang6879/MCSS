...
DATASET = 'MSL'     # ['DFC22', 'iSAID', 'MER', 'MSL', 'Vaihingen', 'GID-15']


# DFC22_class, color_map = DFC22()
# isaid_class, color_map = iSAID()
# vai_class, color_map = Vaihingen()
# gid_class, color_map = GID15()
msl_class, color_map = MARS()
...
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/DFC22/1-8_0.5/RanPaste/__to_/_/ResUNet_resnet50_RanPaste_epoch_192_36.45.pth'
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/DFC22/1-8_0.5/RanPaste/__to_/_/ResUNet_resnet50_RanPaste_epoch_192_36.45.pth'
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/DFC22/1-8_20_1/SDC/ResUNet_resnet50_my_strategy_dualmatch_th=0.95_37.20.pth'
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/DFC22/1-8_20_1/SDC/ResUNet_resnet50_my_strategy_dualmatch_th=0.95_38.13.pth'
...
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/DFC22/1-8_20_0.5/SDC/ResUNet_resnet50_my_strategy_WSCL_40.32.pth'
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/DFC22/1-8_0.5/train_SGM/' \
#           '_1.0_to_0.1/_/SGM/ResUNet_resnet50_train_SGM_0.20__1.00_to_0.10_weight_0.50_epoch_277_42.67.pth'
# MEMORY_WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/DFC22/1-8_0.5/train_SGM/' \
#           '_1.0_to_0.1/_/SGM/ResUNet_resnet50_train_SGM_0.20__1.00_to_0.10_weight_0.50_epoch_277_42.67.pth'
...
#ICNet
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/MSL/1-8_0.5/WSCL/__to_/SDC_/' \
#           'ResUNet_resnet50_59.31.pth'

#RanPaste
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/MSL/1-4_0.5/fixmatch/single_0.0_to_0.0/_/' \
#           'ResUNet_resnet50_fixmatch_single_0.00_weight_0.50_epoch_92_58.54.pth'
...
# SGMCR
WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/MSL/1-4_0.5/train_SGM/_1.0_to_0.8/_/SGM/' \
          'ResUNet_resnet50_train_SGM_0.20__1.00_to_0.80_weight_0.50_epoch_59_63.50.pth'
MEMORY_WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/MSL/1-4_0.5/train_SGM/_1.0_to_0.8/_/SGM/' \
          'ResUNet_resnet50_train_SGM_0.20__1.00_to_0.80_weight_0.50_epoch_59_63.50.pth'
...
#FixMatch
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/GID-15/1-8_0.5/fixmatch/single_0.95_to_0.95' \
#           '/_/ResUNet_resnet50_fixmatch_single_0.95_weight_0.50_epoch_103_70.01.pth'
#ICNet
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/GID-15/1-8_0.5/icnet/__to_/_/' \
#           'ResUNet_resnet50_icnet_epoch_64_65.25.pth'

#RanPaste
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/GID-15/1-8_0.5/RanPaste/__to_/_/' \
#           'ResUNet_resnet50_RanPaste_epoch_167_68.53.pth'
...
# SGMCR
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/GID-15/1-8_0.5/train_SGM/_1.0_to_0.9/_/SGM/' \
#           'ResUNet_resnet50_train_SGM_0.20__1.00_to_0.90_weight_0.50_epoch_36_77.02.pth'
# MEMORY_WEIGHTS =  '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/GID-15/1-8_0.5/train_SGM/_1.0_to_0.9/_/SGM/' \
#           'ResUNet_resnet50_train_SGM_0.20__1.00_to_0.90_weight_0.50_epoch_36_77.02.pth'
...
# SGMCR
# WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/Vaihingen/1-8_0.5/train_SGM/_1.0_to_0.8/_/SGM/' \
#           'ResUNet_resnet50_train_SGM_0.10__1.00_to_0.80_weight_0.50_epoch_197_74.69.pth'
# MEMORY_WEIGHTS = '/data1/users/lvliang/project_123/WSCL-main/WSCL-main/exp/Vaihingen/1-8_0.5/train_SGM/_1.0_to_0.8/_/SGM/' \
#           'ResUNet_resnet50_train_SGM_0.10__1.00_to_0.80_weight_0.50_epoch_197_74.69.pth'
...
def parse_args():
    ...
    # basic settings
    parser.add_argument('--data-root', type=str, default=MSL_DATASET_PATH)
...
def main(args):
    ...
    eval(model, valloader, args, memory)
...
def eval(model, valloader, args, memory=None):
    ...
    with torch.no_grad():
        ...
        # for img, mask, id in tbar:
            ...
            # pre_prob, pre_batch = torch.softmax(pre_batch, dim=1).max(dim=1)
            # pre_batch[pre_prob<0.999] = 15
            # pre_batch = pre_batch.cpu().numpy()
            ...
            for i in range(len(img_batch)):
                ...
                result.save('/data1/users/lvliang/project_123/WSCL-main/WSCL-main/visual_result/' + DATASET + '/' + Method +'/' + labels_content )
